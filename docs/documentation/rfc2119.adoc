...
link:https://tools.ietf.org/html/rfc2119[This RFC, , window="_blank"] defines keywords for other RFCs, when defining requirement levels. Specifically:
...
Note that only upper-case usages of these terms constitute the designated meanings above, per updates to this RFC from link:https://tools.ietf.org/html/rfc8174[RFC 8174, window="_blank"].
